...
df0 = pd.read_csv("tuning_results/general/metrics_general.csv", index_col=[0])
...
plt.legend()
plt.grid(True)
plt.savefig("tuning_plot.png")  # Save the plot as a PNG image
