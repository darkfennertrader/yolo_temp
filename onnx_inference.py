...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model",
        type=str,
        default="models/fine_tuned_Mar24.onnx",
        help="Input your ONNX model.",
    )
    parser.add_argument(
        "--img",
        type=str,
        default="yolo_dataset/mar24/test2/BellaniB_001_p_p.jpeg",
        help="Path to input image.",
    )
    parser.add_argument(
        "--conf-thres", type=float, default=0.535, help="Confidence threshold"
    )
    parser.add_argument(
